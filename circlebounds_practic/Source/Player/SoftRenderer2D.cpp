...
void SoftRenderer::Render2D()
{
	...
	// 의도적으로 짧게 설정
	//cameraCircleBound.Radius = 350.f;
	/*cameraRectangleBound.Max = Vector2(150, 150);
	cameraRectangleBound.Min = Vector2(-150, -150);*/
	...
	_RSI->PushStatisticText("Culled by Rectangle : " + std::to_string(boxObjectCount));
